...
보존하면서 decision table과 binding 제약을 추가하고, `0003_runtime_commands`가 durable
명령 table과 Task별 단일 pending 제약을 추가한다. 현재 head에 반복 적용하면 schema
...
revision의 Task를 보존한 채 0003 head로 upgrade되는지 확인한다. source package를
